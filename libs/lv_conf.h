...
/* Adjust these based on your actual display resolution */
#define LV_HOR_RES_MAX     480 /* [px] Horizontal resolution */
#define LV_VER_RES_MAX     320 /* [px] Vertical resolution */
